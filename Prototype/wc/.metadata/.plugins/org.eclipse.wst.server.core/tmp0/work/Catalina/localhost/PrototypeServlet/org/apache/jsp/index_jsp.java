 ...
 * Generated at: 2019-02-24 14:08:43 UTC
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("        $.ajax({\r\n");
      out.write("          type: 'POST',\r\n");
      out.write("          data: { method: 'canvas', hash: hash },\r\n");
      ...
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    function fingerprint_browser() {\r\n");
      ...
      out.write("        try {\r\n");
      out.write("        // timezone\r\n");
      out.write("        var date1 = new Date(2019, 0, 1);\r\n");
      out.write("        var date2 = new Date(2019, 6, 1);\r\n");
      out.write("        var date1Offset = date1.getTimezoneOffset();\r\n");
      out.write("        var date2Offset = date2.getTimezoneOffset();\r\n");
      out.write("     \r\n");
      out.write("        // language\r\n");
      out.write("         var language = navigator.language ? navigator.language : \"undefined\";\r\n");
      out.write("        var languages = navigator.languages ? navigator.languages : \"undefined\";\r\n");
      out.write("        // there are MS specified properties (navigator.browserlanguage)\r\n");
      out.write("        // not used - as prototype for multiple OS\r\n");
      out.write("\r\n");
      out.write("\t\t// java enabled\r\n");
      out.write("\t\tvar javaEnabled = navigator.javaEnabled() ? true : false;\r\n");
      out.write("        \r\n");
      out.write("        // display\r\n");
      out.write("        if(window.screen) {\r\n");
      out.write("        \t var screenAvailWidth = window.screen.availWidth;\r\n");
      out.write("             var screenAvailHeight = window.screen.availHeight;\r\n");
      out.write("             var screenWidth = window.screen.width;\r\n");
      out.write("             var screenHeight = window.screen.height;\r\n");
      out.write("             var screenColorDepth = window.screen.colorDepth;\r\n");
      out.write("        }\r\n");
      out.write("        \r\n");
      out.write("        // geolocation\r\n");
      out.write("        console.log(navigator.geolocation);\r\n");
      out.write("        \r\n");
      out.write("        // useragent string\r\n");
      out.write("        var uas = navigator.userAgent;\r\n");
      out.write("        \r\n");
      out.write("        hash = uas + \" | \" + screenAvailWidth + \" | \" + screenAvailHeight + \" | \" + screenWidth + \" | \" + screenHeight + \" | \" +\r\n");
      out.write("        \t\tscreenWidth + \" | \" + screenColorDepth + \" | \" + javaEnabled + \" | \" + language + \" | \" + languages + \" | \" +\r\n");
      out.write("        \t\tdate2Offset + \" | \" + date1Offset;\r\n");
      out.write("        \r\n");
      out.write("        console.log(hash);\r\n");
      out.write("          // send hash to servlet\r\n");
      out.write("          $.ajax({\r\n");
      out.write("            type: 'POST',\r\n");
      out.write("            data: { method: 'browser', hash: hash },\r\n");
      out.write("            url: 'Fingerprinting',\r\n");
      out.write("            success: function (result) {\r\n");
      out.write("              $('#result2').html(result);\r\n");
      out.write("            }\r\n");
      out.write("          });\r\n");
      out.write("\r\n");
      out.write("          return hash;\r\n");
      ...
      out.write("          how does it work, what's its weakness\r\n");
      out.write("        </div>\r\n");
      out.write("        <div class=\"panel-footer\" id=\"result2\">\r\n");
      out.write("         <button type=\"button\" class=\"btn btn-info\" onclick=\"fingerprint_browser();\">Check Browser Fingerprint</button>\r\n");
      out.write("        </div>\r\n");
      out.write("      </div>\r\n");
      out.write("    </div>\r\n");
      out.write("\r\n");
