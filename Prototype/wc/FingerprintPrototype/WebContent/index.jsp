        ...
        <div class="table-content">
         <div class="row" style="font-weight: bold;">
		  ...
		  <div class="row" style="background-color: #e5e5e0;">
		    <div class="col-sm-2" style="font-weight: bold;">Windows</div>
		    <div class="col-sm-2"></div>
		    <div class="col-sm-2"></div>
		    <div class="col-sm-2"></div>
		    <div class="col-sm-2"></div>
		  ...
		  <div class="row">
		    <div class="col-sm-2" style="font-weight: bold;">Mac OS</div>
		    <div class="col-sm-2"></div>
		    <div class="col-sm-2"></div>
		    <div class="col-sm-2"></div>
		    <div class="col-sm-2"></div>
		  ...
		  <div class="row" style="background-color: #e5e5e0;">
		    <div class="col-sm-2" style="font-weight: bold;">Linux</div>
		    <div class="col-sm-2"></div>
		    <div class="col-sm-2"></div>
		    <div class="col-sm-2"></div>
		    <div class="col-sm-2"></div>
